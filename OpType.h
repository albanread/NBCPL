...
enum class OpType {
    ...
    // Vector/SIMD
    FMLA_VECTOR, FMUL_VECTOR, ADD_VECTOR, SUB_VECTOR, LD1_VECTOR, ST1_VECTOR, SMIN_VECTOR, SMAX_VECTOR, SMINP_VECTOR, UZP1_VECTOR, UZP2_VECTOR, FADD_VECTOR, FMIN_VECTOR, FMAX_VECTOR, MUL_VECTOR, UMOV,
    // Floating-point Math
    FSQRT
};
