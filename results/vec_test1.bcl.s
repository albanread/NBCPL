...
L_START:
    ...
    ADRP X19, BCPL_ALLOC_WORDS@PAGE
    ADD X19, X19, BCPL_ALLOC_WORDS@PAGEOFF
    ...
    MOV X0, X10
    ADRP X20, WRITES@PAGE
    ADD X20, X20, WRITES@PAGEOFF
    BL _WRITES
    LDR X10, [X28]
    LDR X11, [X28, #8]
    MUL X10, X10, X11
    MOV X0, X10
    ADRP X19, WRITEN@PAGE
    ADD X19, X19, WRITEN@PAGEOFF
    BL _WRITEN
...
L_6:
    ...
    LDR X22, [X29, #112]
    MOV X0, X22
    ADRP X19, FREEVEC@PAGE
    ADD X19, X19, FREEVEC@PAGEOFF
    BL _FREEVEC
