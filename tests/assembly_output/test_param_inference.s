...
L_TestIntFunc_Entry_0:
    MOV X9, X27
    ADD X9, X9, X26
    MOV X0, X9
    B L_0
    B L_TestIntFunc_Exit_1
L_TestIntFunc_Exit_1:
    B L_0
L_0:
...
L_TestFloatFunc:
    ...
    FMOV D15, D0
    FMOV D14, D1
L_TestFloatFunc_Entry_0:
    FMOV D0, D15
    FMUL D0, D0, D14
    B L_1
    B L_TestFloatFunc_Exit_1
L_TestFloatFunc_Exit_1:
    B L_1
L_1:
...
L_TestUnusedParam:
    ...
    MOV X27, X0    // Move parameter 'used' from X0 to X27
L_TestUnusedParam_Entry_0:
    MOVZ X9, #2
    MOV X10, X27
    MUL X10, X10, X9
    MOV X0, X10
    B L_2
    B L_TestUnusedParam_Exit_1
L_TestUnusedParam_Exit_1:
    B L_2
L_2:
    LDR X19, [X29, #32] ; Restored Reg: X19 @ FP+32
    LDR X20, [X29, #40] ; Restored Reg: X20 @ FP+40
