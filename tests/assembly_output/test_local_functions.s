...
L_MyHelperFunction_Entry_0:
    B L_MyHelperFunction_Exit_1
L_MyHelperFunction_Exit_1:
    B L_0
L_0:
...
L_MyHelperRoutine_Entry_0:
    ...
    MOV X3, X27
    BL _WRITEF3
    B L_MyHelperRoutine_Exit_1
L_MyHelperRoutine_Exit_1:
    B L_1
L_1:
...
L_START_Entry_0:
    ...
    MOV X20, X27
    MOV X0, X20
    BL L_MyHelperFunction
    MOV X25, X0
    MOV X0, X27
    MOV X1, X26
    BL L_MyHelperRoutine
    ADD X25, X25, X26
    MOV X27, X25
    MOVZ X9, #3
    MUL X27, X27, X9
