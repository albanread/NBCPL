...
L_FACTORIAL_ITERATIVE_BlockCleanup_6:
    B L_FACTORIAL_ITERATIVE_Exit_5
L_FACTORIAL_ITERATIVE_Exit_5:
    B L_1
L_FACTORIAL_ITERATIVE_ForBody_2:
    MUL X27, X27, X25
    B L_FACTORIAL_ITERATIVE_ForIncrement_3
L_FACTORIAL_ITERATIVE_ForExit_4:
    MOV X0, X27
    B L_1
    B L_FACTORIAL_ITERATIVE_Exit_5
L_FACTORIAL_ITERATIVE_ForHeader_1:
    MOV X9, X25
    CMP X9, X26
    B.GT L_FACTORIAL_ITERATIVE_ForExit_4
