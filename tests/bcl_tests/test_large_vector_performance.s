...
L_START_ForBody_22:
    ADRP X13, L_str4@PAGE
    ADD X13, X13, L_str4@PAGEOFF
    ADD X13, X13, #8
    MOV X0, X13
    MOV X1, X22
    MOV X13, X22
...
L_START_ForExit_12:
    ...
    MOV X9, X0
    MOV X0, X10
    ; DEBUG: Setting vector length to 100
    MOVZ X11, #100
    ...
    ADD X9, X9, #8
    ; === DEBUG: Starting chunked reduction with cursors ===
    ; === Chunked Vector Reduction: 100 PAIRS ===
    MOV X10, X24
    MOV X11, X23
    MOV X12, X9
    .quad 0x0
