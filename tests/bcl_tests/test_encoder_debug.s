...
L_test_function1_Entry_0:
    ADRP X9, L_str0_plus_8@PAGE
    ADD X9, X9, L_str0_plus_8@PAGEOFF
    MOV X0, X9
    LDR X9, [X28, #0] ; test_global
    BL _WRITEF1
    MOVZ X9, #100
    STR X9, [X28, #0] ; test_global
    MOV X27, X9
    ...
    MOV X1, X9
    BL _WRITEF1
    B L_test_function1_Exit_1
L_test_function1_Exit_1:
    B L_0
L_0:
    LDP x19, x27, [x29, #16]
...
L_test_function2:
    ...
    ADRP X28, L__data_segment_base@PAGE
    ADD X28, X28, L__data_segment_base@PAGEOFF
L_test_function2_Entry_0:
    ADRP X9, L_str2_plus_8@PAGE
    ADD X9, X9, L_str2_plus_8@PAGEOFF
    MOV X0, X9
    LDR X9, [X28, #8] ; another_global
    MOV X1, X9
    BL _WRITEF1
    MOVZ X9, #777
    STR X9, [X28, #8] ; another_global
    MOV X27, X9
    ...
    MOV X1, X9
    BL _WRITEF1
    B L_test_function2_Exit_1
L_test_function2_Exit_1:
    B L_1
L_1:
    LDP x19, x27, [x29, #16]
    LDR X28, [X29, #32] ; Restored Reg: X28 @ FP+32
