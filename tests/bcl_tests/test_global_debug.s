...
L_test_arithmetic_Entry_0:
    ...
    LDR X9, [X28, #0] ; test_global
    BL _WRITEF1
    B L_test_arithmetic_Exit_1
L_test_arithmetic_Exit_1:
    B L_2
L_2:
    LDP x19, x20, [x29, #32]
    LDP x21, x25, [x29, #48]
