...
L_Animal_Move:
    ...
    ADRP X28, L__data_segment_base@PAGE
    ADD X28, X28, L__data_segment_base@PAGEOFF
L_Animal_Move_Entry_0:
    ADRP X9, L_str1_plus_8@PAGE
    ADD X9, X9, L_str1_plus_8@PAGEOFF
    MOV X0, X9
    BL _WRITEF
    B L_Animal_Move_Exit_1
L_Animal_Move_Exit_1:
    B L_1
L_1:
    LDP x19, x27, [x29, #24]
    LDR X28, [X29, #40] ; Restored Reg: X28 @ FP+40
...
L_START_Entry_0:
    ...
    STR X9, [X21, #0] ; store vtable ptr
    MOV X22, X21
    MOVZ X0, #8
    BL _OBJECT_HEAP_ALLOC
    MOV X21, X0
    ADRP X9, L_Cat_vtable@PAGE
    ADD X9, X9, L_Cat_vtable@PAGEOFF
    STR X9, [X21, #0] ; store vtable ptr
    MOV X26, X21
    MOVZ X0, #8
    BL _OBJECT_HEAP_ALLOC
    MOV X21, X0
    ADRP X9, L_Bird_vtable@PAGE
    ADD X9, X9, L_Bird_vtable@PAGEOFF
    STR X9, [X21, #0] ; store vtable ptr
    MOV X27, X21
    ...
    BL _WRITEF
    MOV X23, X22
    ADRP X9, L_str30_plus_8@PAGE
    ADD X9, X9, L_str30_plus_8@PAGEOFF
    MOV X0, X9
    BL _WRITEF
    MOV X0, X23
    BL L_Bird_Speak
    ADRP X9, L_str31_plus_8@PAGE
    ADD X9, X9, L_str31_plus_8@PAGEOFF
    MOV X0, X9
    BL _WRITEF
    MOV X0, X23
    BL L_Bird_Move
    MOV X23, X26
    ADRP X9, L_str32_plus_8@PAGE
    ADD X9, X9, L_str32_plus_8@PAGEOFF
    MOV X0, X9
    BL _WRITEF
    MOV X0, X23
    BL L_Bird_Speak
    ADRP X9, L_str33_plus_8@PAGE
    ADD X9, X9, L_str33_plus_8@PAGEOFF
    MOV X0, X9
    BL _WRITEF
    MOV X0, X23
    BL L_Bird_Move
    MOV X23, X27
    ADRP X9, L_str34_plus_8@PAGE
    ADD X9, X9, L_str34_plus_8@PAGEOFF
    MOV X0, X9
    BL _WRITEF
    MOV X0, X23
    BL L_Bird_Speak
    ADRP X9, L_str35_plus_8@PAGE
    ADD X9, X9, L_str35_plus_8@PAGEOFF
    MOV X0, X9
    BL _WRITEF
    MOV X0, X23
    BL L_Bird_Move
    ...
    MOV X0, X9
    BL _WRITEF
    ADRP X9, L_str36_plus_8@PAGE
    ADD X9, X9, L_str36_plus_8@PAGEOFF
    MOV X0, X9
    BL _WRITEF
    MOV X23, X22
    MOV X23, X22
    ADRP X9, L_str37_plus_8@PAGE
    ADD X9, X9, L_str37_plus_8@PAGEOFF
    MOV X0, X9
    BL _WRITEF
    MOV X0, X23
    BL L_Cat_Speak
    MOV X23, X26
    ADRP X9, L_str38_plus_8@PAGE
    ADD X9, X9, L_str38_plus_8@PAGEOFF
    MOV X0, X9
    BL _WRITEF
    MOV X0, X23
    BL L_Cat_Speak
    MOV X23, X27
    ADRP X9, L_str39_plus_8@PAGE
    ADD X9, X9, L_str39_plus_8@PAGEOFF
    MOV X0, X9
    BL _WRITEF
    MOV X0, X23
    BL L_Cat_Speak
    MOV X23, X22
    ADRP X9, L_str40_plus_8@PAGE
    ADD X9, X9, L_str40_plus_8@PAGEOFF
    MOV X0, X9
    BL _WRITEF
    MOV X0, X23
    BL L_Cat_Speak
    MOV X23, X26
    ADRP X9, L_str41_plus_8@PAGE
    ADD X9, X9, L_str41_plus_8@PAGEOFF
    MOV X0, X9
    BL _WRITEF
    MOV X0, X23
    BL L_Cat_Speak
    ...
    MOV X0, X9
    BL _WRITEF
    ADRP X9, L_str42_plus_8@PAGE
    ADD X9, X9, L_str42_plus_8@PAGEOFF
    MOV X0, X9
    BL _WRITEF
    MOV X25, X22
    MOV X24, X26
    STR X27, [X29, #72] ; cross3
    ADRP X9, L_str43_plus_8@PAGE
    ADD X9, X9, L_str43_plus_8@PAGEOFF
    MOV X0, X9
    BL _WRITEF
    ADRP X9, L_str44_plus_8@PAGE
    ADD X9, X9, L_str44_plus_8@PAGEOFF
    MOV X0, X9
    BL _WRITEF
    MOV X0, X25
    BL L_Cat_Speak
    ADRP X9, L_str45_plus_8@PAGE
    ADD X9, X9, L_str45_plus_8@PAGEOFF
    MOV X0, X9
    BL _WRITEF
    MOV X0, X24
    BL L_Bird_Speak
    ADRP X9, L_str46_plus_8@PAGE
    ADD X9, X9, L_str46_plus_8@PAGEOFF
    MOV X0, X9
    BL _WRITEF
    LDR X9, [X29, #72] ; cross3
    BL L_Dog_Speak
    STR X25, [X29, #104] ; temp
    MOV X25, X24
    LDR X9, [X29, #72] ; cross3
    MOV X24, X9
    LDR X9, [X29, #104] ; temp
    STR X9, [X29, #72] ; cross3
    ADRP X9, L_str47_plus_8@PAGE
    ADD X9, X9, L_str47_plus_8@PAGEOFF
    MOV X0, X9
    BL _WRITEF
    ADRP X9, L_str44_plus_8@PAGE
    ADD X9, X9, L_str44_plus_8@PAGEOFF
    ...
    MOV X0, X9
    BL _WRITEF
    ADRP X9, L_str48_plus_8@PAGE
    ADD X9, X9, L_str48_plus_8@PAGEOFF
    MOV X0, X9
    BL _WRITEF
